...
<div class="py-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <div>
            <a href="{{ route('admin.schedules.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-2">
                Tambah Jadwal
            </a>
                ...
                @foreach($schedules as $schedule)
                    <tr>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-medium text-gray-900">{{ $schedule->day_name }}, {{ \Carbon\Carbon::parse($schedule->date)->format('d M Y') }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
